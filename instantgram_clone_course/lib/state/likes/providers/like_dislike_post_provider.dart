...
import 'package:instantgram_clone_course/state/likes/models/like.dart';
import 'package:instantgram_clone_course/state/likes/models/like_dislike_request.dart';

// Creates or removes the like object into Firestore
// Not for UI logic provider
final likeDislikePostProvider =
  ...
  // First check if the user has liked the post already
