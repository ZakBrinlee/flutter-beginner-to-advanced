...
import 'package:instantgram_clone_course/views/components/rich_text/rich_text_widget.dart';
    ...
    return RichTextWidget(
      ...
      texts: [
        ...
        BaseText.link(
          ...
          onTapped: () => launchUrl(Uri.parse(Strings.facebookSignupUrl)),
        ),
        BaseText.plain(text: Strings.orCreateAnAccountOn),
        BaseText.link(
          text: Strings.google,
          onTapped: () => launchUrl(Uri.parse(Strings.googleSignupUrl)),
        ),
      ],
    );
  }
